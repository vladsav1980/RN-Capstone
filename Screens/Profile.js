  ...
  return (
    <View style={styler.head}>
      <View style={styler.sub}>
        <Pressable
          style={{ flex: 0.35, marginTop: 0.1 }}
          onPress={() => {
            navigation.navigate("Home");
          }}
        >
          <Entypo
            style={styler.imagearrow}
      ...
      <View style={styler.sub2}>
        ...
        <Pressable style={styler.button90}>
          <Text style={styler.text11} onPress={pickImage}>
            Change
          </Text>
        </Pressable>
        <View style={styler.tp2}></View>
        <Pressable style={styler.button91}>
          <Text style={styler.text14} onPress={() => setImage(null)}>
            Remove
          </Text>
        </Pressable>
      </View>
      <View>
        <Text style={styler.text1}>First Name</Text>
        <TextInput
          value={firstName}
