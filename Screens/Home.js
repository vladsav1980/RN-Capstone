  ...
  return (
    <View style={styler.head}>
      <View style={styler.sub}>
        ...
        <Image source={require("../assets/Logo.png")} style={styler.image} />
        <View style={{ flex: 0.33, justifyContent: "center" }}>
          {im ? (
            <Pressable
              style={{ flex: 0.33, marginLeft: 60 }}
              onPress={() => {
            ...
            <Pressable
              style={{ flex: 0.33, marginLeft: 60, marginTop: 4 }}
              onPress={() => {
                navigation.navigate("Profiles");
              }}
            >
      ...
      <View style={{ flex: 0.4 }}>
        <View style={{ backgroundColor: "darkolivegreen" }}>
          ...
          <Text style={{ color: "white", fontSize: 30, marginLeft: 8 }}>
            Chicago
          </Text>
          <Searchbar
            placeholder="Search"
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Item
              ...
              url={`https://github.com/Meta-Mobile-Developer-PC/Working-With-Data-API/blob/main/images/${item.image}?raw=true`}
            />
          )}
